  ...
  return ( 
    <div className="featuredProperties">
      ...
      <div className="featuredPropertyContainer">
        ...
        <FeaturedProperty img={featured2} alt={"property image"} price={"100,000,000"} location={"Kubwa Abuja"} type={"For Sale"} setting={"4 bedroom duplex"} description={"A beautiful 4 bedroom duplex in the heart of Kubwa Abuja. The building is located in a secure and serene environment. "} area={"900 sqft"} beds={"4"} baths={"6"} detailsPage={"#"} />
      </div>
    </div>
   );
}
